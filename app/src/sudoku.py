...
from .constants import EMPTY, NUMBERS_TYPE
from .possibles_matrix import PossiblesMatrix
from .types import Index, Matrix, Vector
from .utils import Axis, find_least_filled_place_in_matrix, get_matrix_combinations, sudoku_is_valid
...
class Sudoku:
    ...
    This object represents 9x9 array, and legal numbers to be put into every cell.
    ...
    def is_solved(self) -> bool:
        return EMPTY not in self.array
